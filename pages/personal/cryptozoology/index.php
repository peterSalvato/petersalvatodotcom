...
<body>
    ...
    <section id="mainContent">
      <h1>Cryptozoology</h1>
      <p>Explore our cryptozoology projects, focusing on:</p>
      <ul>
        <li><strong>Research:</strong> Investigating and documenting elusive and mysterious creatures.</li>
        <li><strong>Fieldwork:</strong> Conducting expeditions and collecting evidence to support the existence of cryptids.</li>
        <li><strong>Documentation:</strong> Creating detailed reports and visual documentation of findings.</li>
      </ul>
      <p>Our work in cryptozoology aims to shed light on the unknown and spark curiosity about the mysteries of the natural world.</p>
    </section>
